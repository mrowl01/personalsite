...
class Banner extends Component {
	render(){
		return(
		<div className = 'banner fl bg-navy w-25  vh-100 tc '>
			<img 
			...
			<div className= 'container socialMediaIcons'>
				...
				<br/>
				<a class="f6 link dim ph3 pv2 mb2 dib white bg-mid-gray br-pill" href="#0">Home</a>
				<br/>
				<a class="f6 link dim ph3 pv2 mb2 dib white bg-mid-gray br-pill" href="#0">Portfolio</a>
				<br/>
				<a class="f6 link dim ph3 pv2 mb2 dib white bg-mid-gray br-pill" href="#0">About Me</a>
			</div>
			<div>
